    ...
    render(){
        ...
        const styles = StyleSheet.create({
            ...
            head2: {
                ...
                position: 'absolute',
                left: this.props.x1 + r*Math.cos(angle * Math.PI / 180) + 10 * Math.cos(angle*Math.PI/180) - 10,
                top: this.props.y1 + r*Math.sin(angle*Math.PI/180) + 10*Math.sin(angle*Math.PI/180)- 5,
                transform: [{ rotate: `${angle}deg` }],   
            },
            head1: {
                width: 0,
                ...
                borderRightColor: 'blue', // Change this to the color you want
                position: 'absolute',
                left: this.props.x2 + r*Math.cos((180+angle) * Math.PI / 180) + 10 * Math.cos((180+angle)*Math.PI/180) - 10,
                top: this.props.y2 + r*Math.sin((180+angle)*Math.PI/180) + 10*Math.sin((180+angle)*Math.PI/180)- 5,
        ...
        return (
        <Pressable onPressIn={() => {this.props.onEdgePress(this)}}>
            <View style={[styles.line, (this.state.isAttacked)?styles.attackedLineColor:styles.lineColor]}/>
