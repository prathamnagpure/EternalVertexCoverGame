...
// Your map or object
function writeJson(yourMap,num)
{
    const fs = require("fs");
// Convert the map/object to a JSON string
console.log(yourMap);
const jsonContent = JSON.stringify(Object.fromEntries(yourMap));
console.log(jsonContent);
// Path to the JSON file where you want to store the data
const filePath = 'assets/graphMaps/file'+num+'.json'; // Replace this with your desired file path
...
writeJson(giveMap( 7 , [0, 1, 4, 5, 8, 10, 12] , [[1, 3], [0, 2], [1], [4, 0, 5], [3, 6], [6, 3, 7], [5, 4, 8], [5, 10], [6, 11], [12], [7, 11], [10, 12, 8], [11, 9]] , [[0, 1], [1, 2], [3, 4], [0, 3], [5, 6], [3, 5], [4, 6], [5, 7], [7, 10], [10, 11], [11, 12], [9, 12], [6, 8], [8, 11]] , 6 ,),14);
