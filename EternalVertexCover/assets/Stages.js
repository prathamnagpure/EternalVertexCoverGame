...
export default stages = [
  ...
  {graph: graph7, guardCount: 4, moves:6},
  {graph: graph8, guardCount: 2, moves:5,guards:[1,2]},
  {graph: graph9, guardCount: 4, moves:3,guards:[0,1,2,4]},
  {graph: graph10, guardCount: 4, moves:5,guards:[5,1,2,4]},
  {graph: graph11, guardCount: 6, moves:7,guards:[5,1,2,4,6,8]},
  {graph: graph12, guardCount: 5, moves:7,guards:[5,1,4,6,7]},
];
